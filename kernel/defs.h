...
uint64          uvmalloc_kpg(pagetable_t, pagetable_t, uint64, uint64);
uint64          uvmdealloc(pagetable_t, uint64, uint64);
uint64          uvmdealloc_kpg(pagetable_t, pagetable_t, uint64, uint64);
#ifdef SOL_COW
#else
int             uvmcopy(pagetable_t, pagetable_t, uint64);
int             uvmcopy_kpg(pagetable_t, pagetable_t, pagetable_t, uint64);
#endif
